...
from code.cv_models.liveness.model_training.dataset import PersonDataset
from code.cv_models.liveness.model_training.utils import (
    calculate_metrics,
    calculate_roc_auc,
...
from .utils import calculate_average_precision, calculate_confusion_matrix, calculate_metrics, calculate_roc_auc
